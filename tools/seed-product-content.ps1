...
$content = @(
  @{ h="clarity-cleanser"
     ...
     ben=@("Removes sunscreen and grime in one wash, no double cleanse needed","Buffered salicylic acid keeps pores clear without stripping","Niacinamide settles the flush that acids usually cause","pH 5.5 and sulphate free, so the barrier stays intact")
  ...
  @{ h="radiance-serum"
     ...
     seoD="Stabilised 10% ethyl ascorbic acid with niacinamide. Fades post-acne marks and evens tone without oxidising in Indian heat." }

  @{ h="barrier-moisturiser"
     ...
     seoT="Barrier Moisturiser - Ceramide and Squalane Cream 50 ml | EMBRAE"
  ...
  @{ h="daily-defence-sunscreen"
     ...
     seoT="Daily Defence Sunscreen SPF 50 PA++++ No White Cast 50 ml | EMBRAE"
  ...
  @{ h="starter-duo-set"
     why="Most people starting a routine buy six things and abandon four. The two that actually matter on day one are a cleanser that does not strip and a moisturiser that rebuilds.||This is those two, and deliberately nothing else."
     ...
     how="Cleansing removes the day without damaging the barrier. The moisturiser puts back the ceramides and lipids that cleansing, hard water and air conditioning take out.||Get these two right and most people find they need far less than they expected."
     use="Cleanser morning and night, moisturiser after each. That is the whole routine.||Add sunscreen in the morning when you are ready for a third step."
     ...
     seoT="The Starter Duo - Cleanser and Moisturiser Set | EMBRAE"
     seoD="The two steps that matter on day one: Clarity Gel Cleanser and Barrier Moisturiser. A complete routine, not a starter for a bigger one." }

  @{ h="morning-ritual-set"
     why="The daylight routine is where tone and pigmentation are won or lost, and the order matters more than most people realise.||Cleanse, brighten, protect - in that sequence, every morning. This is those three steps in one box."
  ...
  @{ h="evening-ritual-set"
     ...
     how="The cleanser takes off the day. The serum works on tone while skin is in its repair window. The moisturiser seals both in and rebuilds the barrier overnight.||Hyaluronic acid without something over it makes skin drier, which is why the moisturiser is not optional here."
     use="Cleanse, then serum on damp skin, then moisturiser while the serum is still tacky.||Every night. Consistency matters more than any individual step."
  ...
  @{ h="complete-routine-set"
     ...
     how="Morning is cleanse, vitamin C, sunscreen - tone and protection. Evening is cleanse, serum, moisturiser - repair.||The same cleanser serves both. That is deliberate, not a shortcut."
     use="Morning: cleanser, Radiance Serum, sunscreen.||Evening: cleanser, Radiance Serum, Barrier Moisturiser.||If your skin is reactive, start with the cleanser and moisturiser only and add the serum in week three."
     ...
     seoD="All four EMBRAE products for morning and night in one box. Cleanser, serum, moisturiser and SPF 50, with nothing left to work out." }

  @{ h="travel-barrier-moisturiser"
     ...
     seoT="Barrier Moisturiser Travel Size 15 ml | EMBRAE"
     seoD="The 15 ml cabin-bag size of the ceramide and squalane Barrier Moisturiser. Same formula, smaller jar." }
)
