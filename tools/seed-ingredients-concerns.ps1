...
$ingredients = @(
  ...
  @{ h="squalane"; name="Squalane"; inci="Squalane (olive derived)"; conc="5%"; kw="oil,olive"
     ...
     prods=@("barrier-moisturiser","travel-barrier-moisturiser")
...
$concerns = @(
  @{ h="dullness"; name="Dullness"; kw="face,portrait"
     short="Skin that looks flat and grey rather than lit."
     ...
     ings=@("vitamin-c","niacinamide"); prods=@("radiance-serum","clarity-cleanser","morning-ritual-set")
  ...
  @{ h="dryness"; name="Dryness"; kw="cream,winter"
     ...
     ings=@("ceramides","squalane","hyaluronic-acid"); prods=@("barrier-moisturiser","starter-duo-set","travel-barrier-moisturiser")
     seoT="Dry Skin - Barrier Repair, Not More Moisturiser | EMBRAE"
  ...
  @{ h="breakouts"; name="Breakouts"; kw="face,skin"
     ...
     rout="A salicylic acid cleanser rather than a scrub. Niacinamide to settle the inflammation. A light moisturiser, because skipping it is what causes the rebound oil.||Four to six weeks. Stopping at week two because nothing has changed is the most common reason people conclude a routine did not work."
     ings=@("salicylic-acid","niacinamide"); prods=@("clarity-cleanser","daily-defence-sunscreen")
  ...
  @{ h="pigmentation"; name="Pigmentation"; kw="face,sun"
     ...
     ings=@("vitamin-c","niacinamide"); prods=@("daily-defence-sunscreen","radiance-serum","morning-ritual-set")
  ...
  @{ h="fine-lines"; name="Fine lines"; kw="face,eye"
     ...
     ings=@("hyaluronic-acid","ceramides","niacinamide"); prods=@("barrier-moisturiser","daily-defence-sunscreen","evening-ritual-set")
     seoT="Fine Lines - Prevention Beats Correction | EMBRAE"
     seoD="Sun does more ageing than time. Why daily SPF outperforms every active for fine lines, and what hydration changes immediately." }
  @{ h="sensitivity"; name="Sensitivity"; kw="face,calm"
     ...
     rout="Strip the routine back to cleanser, moisturiser, sunscreen. Nothing else, for three weeks. Fragrance-free throughout.||Then reintroduce one product at a time, a fortnight apart, and patch test behind the ear for two days first. Slow is the only method that works here."
     ings=@("ceramides","squalane"); prods=@("barrier-moisturiser","starter-duo-set","travel-barrier-moisturiser")
