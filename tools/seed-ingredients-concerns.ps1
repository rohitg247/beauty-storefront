...
$ingredients = @(
  ...
  @{ h="hyaluronic-acid"; name="Hyaluronic acid"; inci="Sodium Hyaluronate"; conc="1%"; kw="water,droplet"
     ...
     prods=@("radiance-serum","barrier-moisturizer")
  ...
  @{ h="squalane"; name="Squalane"; inci="Squalane (olive derived)"; conc="5%"; kw="oil,olive"
     ...
     prods=@("barrier-moisturizer","travel-barrier-moisturizer")
...
$concerns = @(
  ...
  @{ h="dryness"; name="Dryness"; kw="cream,winter"
     ...
     ings=@("ceramides","squalane","hyaluronic-acid"); prods=@("barrier-moisturizer","starter-duo-set","travel-barrier-moisturizer")
  ...
  @{ h="breakouts"; name="Breakouts"; kw="face,skin"
     ...
     ings=@("salicylic-acid","niacinamide"); prods=@("clarity-cleanser","daily-defense-sunscreen")
  ...
  @{ h="pigmentation"; name="Pigmentation"; kw="face,sun"
     ...
     ings=@("vitamin-c","niacinamide"); prods=@("daily-defense-sunscreen","radiance-serum","morning-ritual-set")
  ...
  @{ h="fine-lines"; name="Fine lines"; kw="face,eye"
     ...
     ings=@("hyaluronic-acid","ceramides","niacinamide"); prods=@("barrier-moisturizer","daily-defense-sunscreen","evening-ritual-set")
  ...
  @{ h="sensitivity"; name="Sensitivity"; kw="face,calm"
     ...
     ings=@("ceramides","squalane"); prods=@("barrier-moisturizer","starter-duo-set","travel-barrier-moisturizer")
