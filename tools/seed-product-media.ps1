...
#   2. a branded pack card in EMBRAE colours (placehold.co)      - secondary
#
...
$products = @(
  ...
  @{ handle = "barrier-moisturiser";        kw = "moisturizer,cream";  label = "Barrier+Moisturiser";  size = "50+ml";  alt = "Barrier Moisturiser, a ceramide and squalane cream in a 50 ml jar" }
  @{ handle = "daily-defence-sunscreen";    kw = "sunscreen";          label = "Daily+Defence+SPF+50"; size = "50+ml";  alt = "Daily Defence Sunscreen SPF 50 PA++++ in a 50 ml tube" }
  @{ handle = "starter-duo-set";            kw = "skincare,bottles";   label = "The+Starter+Duo";      size = "2+products"; alt = "The Starter Duo gift set containing the Clarity Gel Cleanser and Barrier Moisturiser" }
  ...
  @{ handle = "evening-ritual-set";         kw = "skincare,night";     label = "The+Evening+Ritual";   size = "3+products"; alt = "The Evening Ritual set containing cleanser, serum and moisturiser" }
  ...
  @{ handle = "travel-barrier-moisturiser"; kw = "cream,travel";       label = "Travel+Size";          size = "15+ml";  alt = "Barrier Moisturiser travel size, a 15 ml cabin-bag jar" }
)
