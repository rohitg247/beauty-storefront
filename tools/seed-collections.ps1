...
$copy = @(
  ...
  @{ h="moisturizers"; t="Moisturizers for Barrier Repair | EMBRAE"; d="Fragrance-free ceramide and squalane moisturizers, light enough for humid months and cushioned enough for a Delhi winter."
     i="Most skin problems people bring us are barrier problems wearing another name - dryness, sensitivity, rebound oil, stinging."
     o="A moisturizer is not there to add water. It is there to stop water leaving, and to replace the lipids that hard water, hot showers and air conditioning strip out.||Oily skin needs one too. Skipping it is the most common reason oily skin gets oilier." }
  @{ h="cleansers"; t="Gentle Face Cleansers, Sulfate Free | EMBRAE"; d="Low-foam cleansers that remove sunscreen and city grime without stripping. pH 5.5, sulfate free, with buffered salicylic acid."
  ...
  @{ h="sunscreen"; t="Sunscreen SPF 50 PA++++ No White Cast | EMBRAE"; d="Mineral-led broad spectrum SPF 50 with non-nano zinc oxide. No white cast on Indian skin tones, no sting, wears under makeup."
     i="Sunscreen is the highest-return step in any routine and the one most often skipped, because most of them sting, cast gray, or pill."
  ...
  # --- concerns ---
  @{ h="dullness"; t="Products for Dull Skin | EMBRAE"; d="Vitamin C, gentle cleansing and daily SPF for skin that looks flat and gray. What to use, and how long tone actually takes."
  ...
  @{ h="fine-lines"; t="Products for Fine Lines | EMBRAE"; d="Hydration, barrier support and daily SPF. Why sun does more aging than time, and what changes the look of lines immediately."
  ...
  @{ h="sensitivity"; t="Products for Sensitive Skin | EMBRAE"; d="Fragrance-free ceramide and squalane formulas for skin that stings or flushes. A three-week reset, and how to reintroduce products."
     ...
     o="Strip the routine back to cleanser, moisturizer and sunscreen for three weeks. Then reintroduce one product per fortnight, patch tested behind the ear for two days first.||Everything here is fragrance free, with no essential oils used as fragrance." }
  # --- ingredients ---
  @{ h="vitamin-c"; t="Vitamin C Skincare - 10% Ethyl Ascorbic Acid | EMBRAE"; d="Stabilised vitamin C that survives Indian heat. Why we use ethyl ascorbic acid rather than L-ascorbic acid."
     ...
     o="Most L-ascorbic acid serums oxidize into a brown, useless liquid within weeks of arriving in an Indian bathroom.||A less-studied form that still works in month three beats the best-studied form that died in week two." }
  ...
  @{ h="hyaluronic-acid"; t="Hyaluronic Acid Skincare | EMBRAE"; d="Low molecular weight hyaluronic acid that holds water inside skin. And the mistake that makes skin drier instead."
     ...
     o="It is a humectant, not a moisturizer. Without something sealing it in, on a dry day it pulls water out of your skin rather than into it - the single most common way people use it wrong." }
