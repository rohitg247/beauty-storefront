...
$articles = @(
  ...
  @{ blog="skin-school"; h="what-is-the-skin-barrier"; title="What the skin barrier actually is, and how you broke it"
     ...
     seoD="The skin barrier is a real physical layer, not a metaphor. What strips it, how to recognize the damage, and a routine that repairs it in two weeks." }
  ...
  @{ blog="skin-school"; h="how-long-skincare-takes"; title="How long skincare actually takes to work"
     ...
     seoT="How Long Does Skincare Take to Work? Realiztic Timelines | EMBRAE"
